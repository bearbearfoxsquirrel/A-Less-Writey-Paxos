...
\newcommand{\STATE}{\textsc{acceptor_state }}
...
\@x{}\moduleLeftDash\@xx{ {\MODULE} LessWriteyPaxos}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Integers}%
\@pvspace{8.0pt}%
\@x{ {\CONSTANTS} Rounds ,\, Acceptors ,\, ProposableValues ,\,}%
\@x{\@s{62.95} PromiseQuorums ,\, AcceptQuorums ,\, Epochs}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLES} acceptor\_states ,\, learnt ,\, sent\_messages}%
\@pvspace{8.0pt}%
\@x{ None \.{\defeq}\@w{NONE}}%
\@y{\@s{0}%
 \ensuremath{{\CHOOSE} v} : \ensuremath{v \.{\notin} ProposableValues
}}%
\@xx{}%
\@pvspace{16.0pt}%
\@x{ {\ASSUME} \.{\land} Rounds \.{\subseteq} Nat}%
\@x{\@s{38.24} \.{\land} AcceptQuorums \.{\subseteq} {\SUBSET} Acceptors}%
\@x{\@s{38.24} \.{\land} PromiseQuorums \.{\subseteq} {\SUBSET} Acceptors}%
 \@x{\@s{38.24} \.{\land} \A\, promise\_quorum \.{\in} PromiseQuorums ,\,
 accept\_quorum \.{\in} AcceptQuorums \.{:}}%
\@x{\@s{159.02} ( promise\_quorum \.{\cap} accept\_quorum ) \.{\neq} \{ \}}%
\@x{\@s{38.24} \.{\land} None \.{\notin} ProposableValues}%
\@pvspace{24.0pt}%
\@x{ AllowedMessages \.{\defeq}}%
\@x{\@s{45.1} [ type \.{:} \{\@w{promise\ request} \} ,\,}%
\@x{\@s{51.97} round \.{:} Rounds ]}%
\@x{\@s{16.4} \.{\cup}\@s{17.58} [ type \.{:} \{\@w{Epoch\ promise} \} ,\,}%
\@x{\@s{51.97} acceptor \.{:} Acceptors ,\,}%
\@x{\@s{51.97} round\@s{0.51} \.{:} Rounds ,\,}%
\@x{\@s{51.97} Epoch \.{:} Epochs ,\,}%
 \@x{\@s{51.97} max\_accepted\_Epoch \.{:} Epochs\@s{2.30} \.{\cup} \{ \.{-} 1
 \} ,\,}%
 \@x{\@s{51.97} max\_accepted\_round\@s{0.51} \.{:} Rounds \.{\cup} \{ \.{-} 1
 \} ,\,}%
 \@x{\@s{51.97} max\_accepted\_value\@s{3.47} \.{:} ProposableValues \.{\cup}
 \{ None \} ]}%
\@x{\@s{16.4} \.{\cup}\@s{17.58} [ type \.{:} \{\@w{accept\ request} \} ,\,}%
\@x{\@s{51.97} Epoch \.{:} Epochs ,\,}%
\@x{\@s{51.97} round \.{:} Rounds ,\,}%
\@x{\@s{51.97} value\@s{2.96} \.{:} ProposableValues ]}%
\@x{\@s{16.4} \.{\cup}\@s{17.58} [ type \.{:} \{\@w{accepted} \} ,\,}%
\@x{\@s{51.97} acceptor \.{:} Acceptors ,\,}%
\@x{\@s{51.97} Epoch \.{:} Epochs ,\,}%
\@x{\@s{51.97} round \.{:} Rounds ,\,}%
\@x{\@s{51.97} value\@s{2.96} \.{:} ProposableValues ]}%
\@x{\@s{16.4} \.{\cup}\@s{17.58} [ type \.{:} \{\@w{new\ Epoch} \} ,\,}%
\@x{\@s{51.97} Epoch \.{:} Epochs ]}%
\@pvspace{24.0pt}%
\@x{ EpochPaxosTypeInvariant \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} acceptor\_states \.{\in} [ Acceptors \.{\rightarrow}
 [ current\_Epoch \.{:} Epochs ,\,}%
 \@x{\@s{170.90} max\_round\_promised \.{:} Rounds \.{\cup} \{ \.{-} 1 \}
 \.{\cup} \{ 1 \} ,\,}%
 \@x{\@s{170.90} max\_accepted\_Epoch\@s{2.42} \.{:} Epochs\@s{2.30} \.{\cup}
 \{ \.{-} 1 \} ,\,}%
 \@x{\@s{170.90} max\_accepted\_round\@s{2.93} \.{:} Rounds \.{\cup} \{ \.{-}
 1 \} ,\,}%
 \@x{\@s{170.90} max\_accepted\_value\@s{5.90} \.{:} ProposableValues \.{\cup}
 \{ None \} ] ]}%
\@y{\@s{0}%
 acceptor states
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} sent\_messages \.{\subseteq} AllowedMessages}%
\@x{\@s{16.4} \.{\land} learnt \.{\subseteq} ProposableValues}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
\@x{ InitalState \.{\defeq}}%
\@x{\@s{16.4} \.{\land} sent\_messages \.{=} \{ \}}%
\@y{\@s{0}%
 no messages sent
}%
\@xx{}%
 \@x{\@s{16.4} \.{\land} acceptor\_states \.{=} [ acceptor \.{\in} Acceptors
 \.{\mapsto} [ current\_Epoch \.{\mapsto} 1 ,\,}%
\@x{\@s{220.96} max\_round\_promised \.{\mapsto} \.{-} 1 ,\,}%
\@x{\@s{220.96} max\_accepted\_Epoch\@s{2.42} \.{\mapsto} \.{-} 1 ,\,}%
\@x{\@s{220.96} max\_accepted\_round\@s{2.93} \.{\mapsto} \.{-} 1 ,\,}%
\@x{\@s{220.96} max\_accepted\_value\@s{5.90} \.{\mapsto} None}%
\@x{\@s{214.93} ] ]}%
\@y{\@s{0}%
 no ballots promised
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} learnt \.{=} \{ \}}%
\@y{\@s{0}%
 no values \ensuremath{learnt
}}%
\@xx{}%
\@pvspace{24.0pt}%
 \@x{ Send ( message ) \.{\defeq} sent\_messages \.{'} \.{=} sent\_messages
 \.{\cup} \{ message \}}%
\@pvspace{8.0pt}%
 \@x{ MessageSent ( message ) \.{\defeq} \E\, sent\_message \.{\in}
 sent\_messages \.{:} sent\_message \.{=} message}%
\@pvspace{24.0pt}%
\@x{ SendPromiseRequests ( requesting\_round ) \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} {\lnot} MessageSent ( [ type \.{\mapsto}\@w{promise\
 request} ,\, round \.{\mapsto} requesting\_round ] )}%
 \@x{\@s{16.4} \.{\land} Send ( [ type \.{\mapsto}\@w{promise\ request} ,\,
 round \.{\mapsto} requesting\_round ] )}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} learnt ,\, acceptor\_states
 {\rangle}}%
\@pvspace{16.0pt}%
\@x{ SendEpochPromise ( acceptor ,\, requested\_round ) \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} MessageSent ( [ type \.{\mapsto}\@w{promise\ request}
 ,\, round \.{\mapsto} requested\_round ] )}%
 \@x{\@s{16.4} \.{\land} acceptor\_states [ acceptor ] . max\_round\_promised
 \.{\leq} requested\_round}%
 \@x{\@s{16.4} \.{\land} acceptor\_states \.{'} \.{=} [ acceptor\_states
 {\EXCEPT} {\bang} [ acceptor ] . max\_round\_promised \.{=} requested\_round
 ]}%
\@x{\@s{16.4} \.{\land} Send ( [ type \.{\mapsto}\@w{Epoch\ promise} ,\,}%
\@x{\@s{56.16} acceptor \.{\mapsto} acceptor ,\,}%
\@x{\@s{56.16} round\@s{0.51} \.{\mapsto} requested\_round ,\,}%
 \@x{\@s{56.16} Epoch \.{\mapsto} acceptor\_states [ acceptor ] .
 current\_Epoch ,\,}%
 \@x{\@s{56.16} max\_accepted\_Epoch \.{\mapsto} acceptor\_states [ acceptor ]
 . max\_accepted\_Epoch ,\,}%
 \@x{\@s{56.16} max\_accepted\_round\@s{0.51} \.{\mapsto} acceptor\_states [
 acceptor ] . max\_accepted\_round ,\,}%
 \@x{\@s{56.16} max\_accepted\_value\@s{3.47} \.{\mapsto} acceptor\_states [
 acceptor ] . max\_accepted\_value}%
\@x{\@s{56.16} ] )}%
\@x{\@s{12.29} \.{\land} {\UNCHANGED} learnt}%
\@pvspace{16.0pt}%
\@x{ IsEpochPromiseQuorum ( Epoch ,\, round ,\, quorum ) \.{\defeq}}%
\@x{\@s{16.4} \A\, acceptor \.{\in} quorum \.{:}}%
 \@x{\@s{27.72} \E\, message \.{\in} sent\_messages \.{:} \.{\land} message .
 type \.{=}\@w{Epoch\ promise}}%
\@x{\@s{155.88} \.{\land} message . acceptor \.{=} acceptor}%
\@x{\@s{155.88} \.{\land} message . Epoch \.{=} Epoch}%
\@x{\@s{155.88} \.{\land} message . round\@s{0.51} \.{=} round}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@x{}%
\@y{%
 \ensuremath{PromiseQuorumMessages
}}%
\@xx{}%
\@x{}%
\@y{\@s{0}%
...
\@x{}%
\@y{\@s{0}%
 or the highest ordered \ensuremath{Epoch} ballot accepted has the value of
 the one being proposed
}%
\@xx{}%
 \@x{ IsValueSafeInEpochPromiseQuorum ( quorum ,\, Epoch ,\, round ,\, value )
 \.{\defeq}}%
 \@x{\@s{16.4} \.{\lor} \E\, message\_a \.{\in} sent\_messages \.{:} \.{\land}
 message\_a . type \.{=}\@w{Epoch\ promise}}%
\@x{\@s{166.05} \.{\land} message\_a . Epoch \.{=} Epoch}%
\@x{\@s{166.05} \.{\land} message\_a . round\@s{0.51} \.{=} round}%
\@x{\@s{166.05} \.{\land} message\_a . max\_accepted\_value \.{=} value}%
\@x{\@s{166.05} \.{\land} message\_a . acceptor \.{\in} quorum}%
 \@x{\@s{166.05} \.{\land} \A\, message\_b \.{\in} sent\_messages
 \.{\,\backslash\,} \{ message\_a \} \.{:}}%
\@x{\@s{189.80} ( \.{\land} message\_b . type \.{=}\@w{Epoch\ promise}}%
 \@x{\@s{193.90} \.{\land} message\_b . max\_accepted\_value \.{\neq}
 message\_a . max\_accepted\_value}%
\@x{\@s{193.90} \.{\land} message\_b . acceptor \.{\in} quorum}%
\@x{\@s{193.90} \.{\land} message\_b . round\@s{0.51} \.{=} round}%
\@x{\@s{193.90} \.{\land} message\_b . Epoch \.{=} Epoch )}%
 \@x{\@s{174.25} \.{\implies} ( \.{\lor} \.{\land} message\_b .
 max\_accepted\_round\@s{0.51} \.{<} message\_a . max\_accepted\_round}%
 \@x{\@s{204.80} \.{\land} message\_b . max\_accepted\_Epoch \.{=} message\_a
 . max\_accepted\_Epoch}%
 \@x{\@s{193.90} \.{\lor} message\_b . max\_accepted\_Epoch \.{<} message\_a .
 max\_accepted\_Epoch )\@s{61.5}}%
\@y{%
 \ensuremath{((message\_b.type \.{=} \@w{Epoch promise} \.{\land}
 message\_b.Epoch \.{=} Epoch \.{\land} message\_b.round \.{=} round
 \.{\land} message\_b.acceptor \.{\in} quorum) \.{\implies}
 (message\_a.max\_accepted\_Epoch \.{>} message\_b.max\_accepted\_Epoch
 \.{\lor} message\_a.max\_accepted\_round \.{>}
 message\_b.max\_accepted\_round \.{\lor} message\_a.max\_accepted\_value
 \.{=} message\_b.max\_accepted\_value))
}}%
\@xx{}%
\@x{\@s{16.4} \.{\lor} \A\, acceptor \.{\in} quorum \.{:}}%
 \@x{\@s{42.93} \E\, message \.{\in} sent\_messages \.{:} \.{\land} message .
 type \.{=}\@w{Epoch\ promise}}%
\@x{\@s{171.09} \.{\land} message . acceptor \.{=} acceptor}%
\@x{\@s{171.09} \.{\land} message . Epoch \.{=} Epoch}%
\@x{\@s{171.09} \.{\land} message . round\@s{0.51} \.{=} round}%
\@x{\@s{171.09} \.{\land} message . max\_accepted\_Epoch \.{=} \.{-} 1}%
 \@x{\@s{171.09} \.{\land} message . max\_accepted\_round\@s{0.51} \.{=} \.{-}
 1}%
\@x{\@s{171.09} \.{\land} message . max\_accepted\_value\@s{3.47} \.{=} None}%
\@pvspace{8.0pt}%
 \@x{ AcceptRequestAlreadyMadeWithDifferentValue ( Epoch ,\, round ,\, value )
 \.{\defeq}}%
 \@x{\@s{16.4} \E\, other\_value \.{\in} ProposableValues \.{:} MessageSent (
 [ type \.{\mapsto}\@w{accept\ request} ,\,}%
\@x{\@s{234.52} Epoch \.{\mapsto} Epoch ,\,}%
\@x{\@s{234.52} round\@s{0.51} \.{\mapsto} round ,\,}%
\@x{\@s{234.52} value\@s{3.47} \.{\mapsto} other\_value ] )}%
\@pvspace{40.0pt}%
\@x{ SendAcceptRequest ( Epoch ,\, round ,\, value ) \.{\defeq}}%
 \@x{\@s{28.7} \.{\land} {\lnot} AcceptRequestAlreadyMadeWithDifferentValue (
 Epoch ,\, round ,\, value )}%
 \@x{\@s{28.7} \.{\land} \E\, promise\_quorum \.{\in} PromiseQuorums \.{:}
 \.{\land} IsEpochPromiseQuorum ( Epoch ,\, round ,\, promise\_quorum )}%
 \@x{\@s{217.76} \.{\land} IsValueSafeInEpochPromiseQuorum ( promise\_quorum
 ,\, Epoch ,\, round ,\, value )\@s{8.2}}%
\@y{\@s{0}%
 exists a promise quroum where the value is the max accepted value
}%
\@xx{}%
\@x{\@s{28.7} \.{\land} Send ( [ type \.{\mapsto}\@w{accept\ request} ,\,}%
\@x{\@s{68.46} Epoch \.{\mapsto} Epoch ,\,}%
\@x{\@s{68.46} round\@s{0.51} \.{\mapsto} round ,\,}%
\@x{\@s{68.46} value\@s{3.47} \.{\mapsto} value ] )}%
 \@x{\@s{28.7} \.{\land} {\UNCHANGED} {\langle} acceptor\_states ,\, learnt
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ SendAcceptedMessage ( acceptor ,\, Epoch ,\, round ) \.{\defeq}}%
 \@x{\@s{32.8} \.{\land} acceptor\_states [ acceptor ] . current\_Epoch
 \.{\leq} Epoch}%
 \@x{\@s{32.8} \.{\land} acceptor\_states [ acceptor ] . max\_round\_promised
 \.{\leq} round}%
\@x{\@s{32.8} \.{\land} \E\, message \.{\in} sent\_messages \.{:}}%
\@x{\@s{52.11} \.{\land} message . type \.{=}\@w{accept\ request}}%
\@x{\@s{52.11} \.{\land} message . Epoch \.{=} Epoch}%
\@x{\@s{52.11} \.{\land} message . round\@s{0.51} \.{=} round}%
 \@x{\@s{52.11} \.{\land} acceptor\_states \.{'} \.{=} [ acceptor\_states
 {\EXCEPT} {\bang} [ acceptor ] . max\_accepted\_round\@s{2.93} \.{=} round
 ,\,}%
 \@x{\@s{257.32} {\bang} [ acceptor ] . max\_accepted\_Epoch\@s{2.42} \.{=}
 Epoch ,\,}%
 \@x{\@s{257.32} {\bang} [ acceptor ] . max\_accepted\_value\@s{5.90} \.{=}
 message . value ,\,}%
\@x{\@s{257.32} {\bang} [ acceptor ] . max\_round\_promised \.{=} round ,\,}%
\@x{\@s{257.32} {\bang} [ acceptor ] . current\_Epoch \.{=} Epoch ]}%
\@x{\@s{52.11} \.{\land} Send ( [ type \.{\mapsto}\@w{accepted} ,\,}%
\@x{\@s{91.87} acceptor \.{\mapsto} acceptor ,\,}%
\@x{\@s{91.87} Epoch \.{\mapsto} Epoch ,\,}%
\@x{\@s{91.87} round\@s{0.51} \.{\mapsto} round ,\,}%
\@x{\@s{91.87} value\@s{3.47} \.{\mapsto} message . value ] )}%
\@x{\@s{36.89} \.{\land} {\UNCHANGED} {\langle} learnt {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Restart ( acceptor ,\, Epoch ) \.{\defeq}}%
 \@x{\@s{36.28} \.{\land} Epoch \.{>}\@s{4.1} acceptor\_states [ acceptor ] .
 current\_Epoch}%
 \@x{\@s{36.28} \.{\land} acceptor\_states \.{'} \.{=} [ acceptor\_states
 {\EXCEPT} {\bang} [ acceptor ] . current\_Epoch \.{=} Epoch ,\,}%
\@x{\@s{241.49} {\bang} [ acceptor ] . max\_round\_promised \.{=} \.{-} 1 ]}%
 \@x{\@s{36.28} \.{\land} MessageSent ( [ type \.{\mapsto}\@w{new\ Epoch} ,\,
 Epoch \.{\mapsto} Epoch ] )}%
\@x{\@s{36.28} \.{\land} {\UNCHANGED} {\langle} learnt {\rangle}}%
\@pvspace{8.0pt}%
\@x{ BeginNewEpoch ( Epoch ) \.{\defeq}}%
 \@x{\@s{32.8} \.{\land} \A\, acceptor\_b \.{\in} Acceptors \.{:}
 acceptor\_states [ acceptor\_b ] . current\_Epoch \.{<} Epoch}%
 \@x{\@s{32.8} \.{\land} \E\, acceptor\_b \.{\in} Acceptors \.{:}
 acceptor\_states [ acceptor\_b ] . current\_Epoch \.{=} ( Epoch \.{-} 1 )}%
\@y{\@s{0}%
 Epoch 1 higher than old current \ensuremath{Epoch \.{-}} not really needed
}%
\@xx{}%
 \@x{\@s{32.8} \.{\land} Send ( [ type \.{\mapsto}\@w{new\ Epoch} ,\, Epoch
 \.{\mapsto} Epoch ] )}%
 \@x{\@s{32.8} \.{\land} {\UNCHANGED} {\langle} learnt ,\, acceptor\_states
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ RecieveEpochNotification ( acceptor ,\, Epoch ) \.{\defeq}}%
 \@x{\@s{32.8} \.{\land} acceptor\_states [ acceptor ] . current\_Epoch \.{<}
 Epoch}%
 \@x{\@s{32.8} \.{\land} MessageSent ( [ type \.{\mapsto}\@w{new\ Epoch} ,\,
 Epoch \.{\mapsto} Epoch ] )}%
 \@x{\@s{32.8} \.{\land} acceptor\_states \.{'} \.{=} [ acceptor\_states
 {\EXCEPT} {\bang} [ acceptor ] . current\_Epoch \.{=} Epoch ,\,}%
\@x{\@s{238.00} {\bang} [ acceptor ] . max\_round\_promised \.{=} \.{-} 1 ]}%
 \@x{\@s{32.8} \.{\land} {\UNCHANGED} {\langle} sent\_messages ,\, learnt
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Learn ( Epoch ,\, round ,\, value ) \.{\defeq}}%
 \@x{\@s{37.65} \.{\land}\@s{7.15} \E\, accept\_quorum \.{\in} AcceptQuorums
 \.{:}}%
\@x{\@s{60.01} \A\, acceptor \.{\in} accept\_quorum \.{:}}%
\@x{\@s{71.33} MessageSent ( [ type \.{\mapsto}\@w{accepted} ,\,}%
\@x{\@s{131.39} acceptor \.{\mapsto} acceptor ,\,}%
\@x{\@s{131.39} Epoch \.{\mapsto} Epoch ,\,}%
\@x{\@s{131.39} round\@s{0.51} \.{\mapsto} round ,\,}%
\@x{\@s{131.39} value\@s{3.47} \.{\mapsto} value ] )}%
\@x{\@s{33.55} \.{\land} learnt \.{'} \.{=} learnt \.{\cup} \{ value \}}%
 \@x{\@s{33.55} \.{\land} {\UNCHANGED} {\langle} acceptor\_states ,\,
 sent\_messages {\rangle}}%
\@pvspace{8.0pt}%
\@x{ NextState \.{\defeq} \.{\lor} \E\, round \.{\in} Rounds \.{:}}%
\@x{\@s{84.04} \.{\lor} SendPromiseRequests ( round )}%
\@x{\@s{84.04} \.{\lor} \E\, acceptor \.{\in} Acceptors \.{:}}%
\@x{\@s{99.25} \.{\lor} SendEpochPromise ( acceptor ,\, round )}%
 \@x{\@s{99.25} \.{\lor} \E\, Epoch \.{\in} Epochs \.{:} SendAcceptedMessage (
 acceptor ,\, Epoch ,\, round )}%
 \@x{\@s{84.04} \.{\lor} \E\, Epoch \.{\in} Epochs ,\, value \.{\in}
 ProposableValues \.{:}}%
\@x{\@s{99.25} \.{\lor} SendAcceptRequest ( Epoch ,\, round ,\, value )}%
\@x{\@s{99.25} \.{\lor} Learn ( Epoch ,\, round ,\, value )}%
 \@x{\@s{61.61} \.{\lor} \E\, acceptor \.{\in} Acceptors ,\, Epoch \.{\in}
 Epochs \.{:}}%
\@x{\@s{84.04} \.{\lor} Restart ( acceptor ,\, Epoch )}%
\@x{\@s{99.25}}%
\@y{%
 \ensuremath{\.{\lor} BeginNewEpoch(Epoch)
}}%
\@xx{}%
\@x{\@s{84.04} \.{\lor} RecieveEpochNotification ( acceptor ,\, Epoch )}%
\@pvspace{8.0pt}%
 \@x{ EpochPaxosSpecification \.{\defeq} InitalState \.{\lor} {\Box} [
 NextState ]_{ {\langle} acceptor\_states ,\, sent\_messages ,\, learnt
 {\rangle}}}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\@pvspace{16.0pt}%
\@x{ ConsensusOK \.{\defeq} \.{\land} EpochPaxosTypeInvariant}%
\@x{\@s{81.44} \.{\land} \.{\lor} learnt \.{=} \{ \}}%
 \@x{\@s{92.55} \.{\lor} \E\, value \.{\in} ProposableValues \.{:} learnt
 \.{=} \{ value \}}%
\@pvspace{16.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Fri} May 15
 08:24:41 \ensuremath{BST} 2020 by \ensuremath{Michael
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Fri} \ensuremath{Aug} 09
 16:48:26 \ensuremath{BST} 2019 by \ensuremath{Michael
}%
\end{cpar}%
\end{lcom}%
\end{document}
